...
def w2v_trainer_opts(parser):
    ...
    group.add("--dict_file", "-dict_file", type=str, required=True, help="")
    group.add("--src", "-src", type=str, required=True, help="")
    group.add("--tgt", "-tgt", type=str, required=True, help="")
    group.add(
        "--output_src", "-output_src", type=str, default="output_src.txt", help=""
    )
    group.add(
        "--output_tgt", "-output_tgt", type=str, default="output_tgt.txt", help=""
    )
    group.add("--pad_size", "-pad_size", type=int, default=30, help="")
