...
def dict_matching_rate_opts(parser):
    ...
    group.add("-src", type=str, required=True, help=".")
    group.add("-tgt", type=str, required=True, help=".")
...
if __name__ == "__main__":
    ...
    print(
        " * src matching rate. Dictionary: {:.2f}% ({}/{}), Token: {:.2f}% ({}/{})".format(
            src_dict_rate * 100,
            src_word_cor + enc_special_wl,
            len(src_words) + enc_special_wl,
            src_tok_rate * 100,
            src_tok_cor,
            src_tok_tot,
        )
    ...
    print(
        " * tgt matching rate. Dictionary: {:.2f}% ({}/{}), Token: {:.2f}% ({}/{})".format(
            tgt_dict_rate * 100,
            tgt_word_cor + dec_special_wl,
            len(tgt_words) + dec_special_wl,
            tgt_tok_rate * 100,
            tgt_tok_cor,
            tgt_tok_tot,
        )
