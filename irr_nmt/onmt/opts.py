...
def model_opts(parser):
    ...
    group.add(
        "--concept_equalization",
        "-concept_equalization",
        action="store_true",
        help="Use concept equalization",
    )
    group.add("--bert_emb", "-bert_emb", action="store_true", help=".")
    group.add(
        "--bert_type",
        "-bert_type",
        type=str,
...
def preprocess_opts(parser):
    ...
    group.add(
        "--no_special", "-no_special", action="store_true", help="No special args"
    )
    group.add("--pad", "-pad", type=str, default="blank", help=".")
    group.add("--bos", "-bos", type=str, default="s", help=".")
    group.add("--eos", "-eos", type=str, default="/s", help=".")
...
def analysis_opts(parser):
    ...
    # GPU
    group.add(
        "--gpu", "-gpu", default=-1, type=int, help="list of ranks of each process."
    )
