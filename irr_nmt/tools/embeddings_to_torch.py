...
def main():
    ...
    if opt.emb_file_both is not None:
        ...
        set_of_src_and_tgt_vocab = set(enc_vocab.stoi.keys()) | set(
            dec_vocab.stoi.keys()
        )
        logger.info(
